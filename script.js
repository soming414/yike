        ...
        <div class="member-card ${genderClass}" data-id="${member.id}">
            ...
            <div class="card-content">
                ...
                <div class="card-footer">
                    <span class="age-badge">${member.constellation}</span>
            ...
            <div class="detail-content">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">${member.ethnicity}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">
                            <i class="fas fa-birthday-cake"></i> 出生年月：
                        </span>
                        <span class="info-value">${member.birthDate}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">
                            <i class="fas fa-paw"></i> 生肖：
                        </span>
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">${member.constellation}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">

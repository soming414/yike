...
function showEditMemberModal(memberId) {
    ...
    if (memberId) {
        ...
        if (member) {
            ...
            document.getElementById('memberEthnicity').value = member.ethnicity;
            document.getElementById('memberBirthDate').value = member.birthDate;
            document.getElementById('memberConstellation').value = member.constellation;
        ...
        document.getElementById('memberEthnicity').value = '汉族';
        document.getElementById('memberConstellation').value = '金牛座';
...
function saveMember() {
    ...
    const memberData = {
        ...
        constellation: document.getElementById('memberConstellation').value,
